/*! emojione 03-05-2017 */ ! function (ns) {
    ns.emojioneList = {
        ":kiss_mm:": {
    ...
    ns.shortnames = tmpShortNames.join("|"), ns.jsEscapeMap = {
        ...
        var replaceWith, shortname, unicode, fname, alt, category, title, size, mappedUnicode = ns.mapUnicodeToShort();
        if (str = str.replace(ns.regShortNames, function (shortname) {
                ...
                return unicode = ns.emojioneList[shortname].uc_output, fname = ns.emojioneList[shortname].uc_base, category = fname.includes("-1f3f") ? "diversity" : ns.emojioneList[shortname].category, title = ns.imageTitleTag ? 'title="' + shortname + '"' : "", size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : shortname, replaceWith = ns.sprites ? '<span class="emojione emojione-' + size + "-" + category + " _" + fname + '" ' + title + ">" + alt + "</span>" : '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ns.imagePathPNG + fname + '.png"/>'
            }), ns.ascii) {
            var asciiRX = ns.riskyMatchAscii ? ns.regAsciiRisky : ns.regAscii;
            str = str.replace(asciiRX, function (entire, m1, m2, m3) {
                return "undefined" != typeof m3 && "" !== m3 && ns.unescapeHTML(m3) in ns.asciiList ? (m3 = ns.unescapeHTML(m3), unicode = ns.asciiList[m3], shortname = mappedUnicode[unicode], category = unicode.includes("-1f3f") ? "diversity" : ns.emojioneList[shortname].category, title = ns.imageTitleTag ? 'title="' + ns.escapeHTML(m3) + '"' : "", size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : ns.escapeHTML(m3), replaceWith = ns.sprites ? m2 + '<span class="emojione emojione-' + size + "-" + category + " _" + unicode + '"  ' + title + ">" + alt + "</span>" : m2 + '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ns.imagePathPNG + unicode + '.png"/>') : entire
            })
        }
        return str
    }, ns.unicodeToImage = function (str) {
        var replaceWith, unicode, short, fname, alt, category, title, size, mappedUnicode = ns.mapUnicodeToShort(),
        ...
        if (str = str.replace(ns.regUnicode, function (unicodeChar) {
                ...
                return short = mappedUnicode[fname], fname = eList[short].uc_base, unicode = eList[short].uc_output, category = fname.includes("-1f3f") ? "diversity" : eList[short].category, size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : short, title = ns.imageTitleTag ? 'title="' + short + '"' : "", replaceWith = ns.sprites ? '<span class="emojione emojione-' + size + "-" + category + " _" + fname + '" ' + title + ">" + alt + "</span>" : '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ns.imagePathPNG + fname + '.png"/>'
            }), ns.ascii) {
            var asciiRX = ns.riskyMatchAscii ? ns.regAsciiRisky : ns.regAscii;
            str = str.replace(asciiRX, function (entire, m1, m2, m3) {
                return "undefined" != typeof m3 && "" !== m3 && ns.unescapeHTML(m3) in ns.asciiList ? (m3 = ns.unescapeHTML(m3), unicode = ns.asciiList[m3], shortname = mappedUnicode[unicode], category = unicode.includes("-1f3f") ? "diversity" : ns.emojioneList[shortname].category, title = ns.imageTitleTag ? 'title="' + ns.escapeHTML(m3) + '"' : "", size = "32" == ns.spriteSize || "64" == ns.spriteSize ? ns.spriteSize : "32", alt = ns.unicodeAlt ? ns.convert(unicode.toUpperCase()) : ns.escapeHTML(m3), replaceWith = ns.sprites ? m2 + '<span class="emojione emojione-' + size + "-" + category + " _" + unicode + '"  ' + title + ">" + alt + "</span>" : m2 + '<img class="emojione" alt="' + alt + '" ' + title + ' src="' + ns.imagePathPNG + unicode + '.png"/>') : entire
